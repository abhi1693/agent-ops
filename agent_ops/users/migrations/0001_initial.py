# Generated by Django 5.2.12 on 2026-03-29 11:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_types', models.ManyToManyField(related_name='object_permissions', to='contenttypes.contenttype')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_permissions', models.ManyToManyField(blank=True, related_name='groups', to='users.objectpermission')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='users', related_query_name='user', to='users.group')),
                ('object_permissions', models.ManyToManyField(blank=True, related_name='users', to='users.objectpermission')),
            ],
            options={
                'ordering': ('username',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(default=True, help_text='Disable to revoke this token without deleting it.')),
                ('write_enabled', models.BooleanField(default=True, help_text='Permit create, update, and delete operations with this token.')),
                ('key', models.CharField(editable=False, max_length=12, unique=True)),
